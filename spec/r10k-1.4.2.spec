# Generated from r10k-1.4.2.gem by gem2rpm -*- rpm-spec -*-
...
Requires: rubygem(multi_json) => 1.8.4
Requires: rubygem(multi_json) < 1.9
Requires: rubygem(json_pure) => 1.8.2
...
%changelog
* Mon Mar 16 2015 johan <johan@koewacht.net> - 1.4.2-0
- Update to 1.4.2
* Thu Feb 17 2015 johan <johan@koewacht.net> - 1.4.1-1
- Update
